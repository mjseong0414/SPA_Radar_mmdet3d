...
from nuscenes_radar_devkit.nuscenes.map_expansion.arcline_path_utils import discretize_lane, ArcLinePath
from nuscenes_radar_devkit.nuscenes.map_expansion.bitmap import BitMap
from nuscenes_radar_devkit.nuscenes import NuScenes
from nuscenes_radar_devkit.nuscenes.utils.geometry_utils import view_points
...
class NuScenesMap:
    ...
    def __init__(self,
        ...
        if self.version < '1.3':
            raise Exception('Error: You are using an outdated map version (%s)! '
                            'Please go to https://www.nuscenes_radar_devkit.nuscenes.org/download to download the latest map!')
    ...
    def render_egoposes_on_fancy_map(self,
        ...
        This method is heavily inspired by nuscenes_radar_devkit.nuscenes.render_egoposes_on_map(), but uses the map expansion pack maps.
