...
from nuscenes_radar_devkit.eval.detection.utils import category_to_detection_name
from nuscenes_radar_devkit.eval.tracking.data_classes import TrackingBox
from nuscenes_radar_devkit.utils.data_classes import Box
from nuscenes_radar_devkit.utils.geometry_utils import points_in_box
from nuscenes_radar_devkit.utils.splits import create_splits_scenes
    ...
    for sample_token in tqdm.tqdm(sample_tokens, leave=verbose):
        ...
        for sample_annotation_token in sample_annotation_tokens:
            ...
            if box_cls == DetectionBox:
                ...
                from nuscenes_radar_devkit.eval.tracking.utils import category_to_tracking_name
