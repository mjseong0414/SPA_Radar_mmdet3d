...
from nuscenes_radar_devkit.nuscenes.eval.panoptic.evaluate import NuScenesPanopticEval
from nuscenes_radar_devkit.nuscenes.eval.panoptic.get_panoptic_from_seg_det_or_track import generate_panoptic_labels
...
def panop_baselines_from_lidarseg_detect_track(out_dir: str,
    ...
    :param dataroot: Path to the tables and data for the specified version of nuscenes_radar_devkit.nuscenes
...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataroot', type=str, default='/data/sets/nuscenes',
                        help='Path to the tables and data for the specified version of nuscenes_radar_devkit.nuscenes')
