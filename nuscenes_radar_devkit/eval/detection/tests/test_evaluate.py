...
from nuscenes_radar_devkit.eval.detection.constants import DETECTION_NAMES
from nuscenes_radar_devkit.eval.detection.evaluate import DetectionEval
from nuscenes_radar_devkit.eval.detection.utils import category_to_detection_name, detection_name_to_rel_attributes
