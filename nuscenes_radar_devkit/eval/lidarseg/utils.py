...
from nuscenes_radar_devkit.lidarseg.lidarseg_utils import colormap_to_colors, create_lidarseg_legend, get_labels_in_coloring
...
def get_samples_in_eval_set(nusc: NuScenes, eval_set: str) -> List[str]:
    ...
    # Get scenes splits from nuscenes_radar_devkit.
