...
class Detr3DFusion(MVXTwoStageDetector):
    ...
    def forward_train(self,
        ...
        losses = dict()
        losses_fusions = self.forward_pts_train(img_feats, pts_feats, gt_bboxes_3d,
                                            gt_labels_3d, img_metas,
                                            gt_bboxes_ignore)
        losses.update(losses_fusions)
        return losses
    ...
    def simple_test_pts(self, img_feats, pts_feats, img_metas, rescale=False):
